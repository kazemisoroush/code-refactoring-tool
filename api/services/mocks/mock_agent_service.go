...
func (m *MockAgentService) UpdateAgent(arg0 context.Context, arg1 models.UpdateAgentRequest) (*models.UpdateAgentResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAgent", arg0, arg1)
	ret0, _ := ret[0].(*models.UpdateAgentResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateAgent indicates an expected call of UpdateAgent.
func (mr *MockAgentServiceMockRecorder) UpdateAgent(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAgent", reflect.TypeOf((*MockAgentService)(nil).UpdateAgent), arg0, arg1)
}
